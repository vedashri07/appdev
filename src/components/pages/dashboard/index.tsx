...
const Dashboard = () => {
  return (
    <div className="dashboardWrapper">
      ...
      <DashboardSection className="dashboardSection dashboardProjectWrapper">
      ...
      <DashboardSection className="dashboardSection dashboardActivityWrapper">
        <PageHeader>
